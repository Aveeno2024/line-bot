...
async function generatePage1Image(day0Label, day1Label, citiesData, dataTimeStr) {
  try {
    ...
    // ✅ 寫入日期（新座標）
    // 日期1: (550, 205)
    image.print(font, 550, 205, day0Label);
    // 日期2: (850, 205)
    image.print(font, 850, 205, day1Label);
    
    // ✅ 寫入城市燈號（新座標）
    const cityConfigs = [
      { name: '台北市', l1x: 550, l1y: 295, l2x: 850, l2y: 295 },
      { name: '新北市', l1x: 550, l1y: 392, l2x: 850, l2y: 392 },
      { name: '桃園市', l1x: 550, l1y: 489, l2x: 850, l2y: 489 },
      { name: '台中市', l1x: 550, l1y: 586, l2x: 850, l2y: 586 },
      { name: '台南市', l1x: 550, l1y: 683, l2x: 850, l2y: 683 },
      { name: '高雄市', l1x: 550, l1y: 780, l2x: 850, l2y: 780 }
    ];
    ...
    image.scan(692 - 200, 892 - 40, 400, 80, function(x, y, idx) {
      this.bitmap.data[idx] = 255;
      this.bitmap.data[idx + 1] = 255;
      this.bitmap.data[idx + 2] = 255;
      this.bitmap.data[idx + 3] = 255;
    });
    image.print(font, 692, 892, displayTime);
